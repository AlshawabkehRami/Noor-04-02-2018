/*
 * Created By Rami Alshawabkeh  3/18/18 4:02 PM
 */

package NoorProject.DirectorOfInformationTechnology.UsersMenu;
...
public class SecurityAndSafetyManagersInDistrict {

    private By UsersTypeMenuLocator = By.id("divMenuItem_3923");
    private By MyInputLocator = By.id("myInput");
    private By UserNameLinkLocator = By.linkText("مديرو الأمن والسلامة في إدارة التعليم");
    ...
    //أضافة مدير الامن والسلامة في الادارة
    @Test
    public void ADDSecurityAndSafetyManagersInDistrict() throws InterruptedException {
        ...
        WebElement myInputWait = waitQA.until(ExpectedConditions.visibilityOfElementLocated(MyInputLocator));
        myInputWait.sendKeys("السلامة");

        browserQA.findElement(UserNameLinkLocator).click();
